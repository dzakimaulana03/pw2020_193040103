...
<body>
  ...
  <div class="navbar-fixed">
    ...
    <input type="text" name="keyword" autofucus style="width: 150px;background-color: white;height: 25px">
...
<div class="row center card1" style="margin-top: -5px" >
  ...
  <div class="col s12 m3">
    ...
    <?php if (empty($novel)) : ?>
        <div class="row">
          <div class="col s12 m12" style="background-color: black;color: red;text-align: center">
